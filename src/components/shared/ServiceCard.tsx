...
const ServiceCard = ({ icon: Icon, titleKey, descriptionKey }: ServiceCardProps) => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 md:p-8 shadow-2xl hover:shadow-xl hover:bg-gray-300 transition-shadow duration-300 hover:border-accent hover:border-2 text-shadow-lg">
      ...
      <h3 className="text-lg md:text-xl  font-bold text-primary mb-3 text-center">
        {t(titleKey)}
      </h3>
