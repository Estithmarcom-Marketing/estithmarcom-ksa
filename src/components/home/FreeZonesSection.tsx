            ...
            {FREE_ZONES.map((country) => {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-2xl border transition-all duration-200 flex flex-col bg-white/80 backdrop-blur-sm ${
                    isActive
                ...
                >
                  <div className="relative aspect-[4/3] w-full overflow-hidden">
                    ...
                    {/* اسم الدولة فوق الصورة على الموبايل */}
                  ...
                  <div className="p-3 md:p-4 flex flex-col gap-1 text-right">
