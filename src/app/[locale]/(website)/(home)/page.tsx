...
export async function generateMetadata({
  ...
  const title = siteTitle(
    t("home.meta.title" as TranslationKey),
    locale
  );

  const description = t(
    "home.meta.description" as TranslationKey
  );

  const keywords = t(
    "home.meta.keywords" as TranslationKey
  );
...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="-mt-[10vh] relative z-20">
        <BannerSection />
      </section>
